...
app.post("/createProject", async (req, res) => {
    ...
    // console.log( ` project id for manager is ${req.user.project.projectId} startdate ${req.user.project.projectStartDate} and end date is${req.user.project.projectEndDate}`);
